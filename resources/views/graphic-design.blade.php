        ...
        <div class="navbar-menu-wrapper">
          <div class="nav-body">
            ...
            <ul class="navbar-nav nav-menu-top">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarTopDropdown">
                  ...
                  <li><a class="dropdown-item" href="web-designing">Web Design & Development</a></li>
                  <li><a class="dropdown-item" href="3d-art">3D Art</a></li>
                  <!-- <li>
                  ...
                  <li><a class="dropdown-item" href="post-production">Post Production</a></li>
                </ul>
              </li>
              <!-- <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarTopDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarTopDropdown">
                  ...
                  <li><a class="dropdown-item" href="demo.html">All pages</a></li>
                </ul>
              </li> -->
            </ul>
            ...
            <ul class="navbar-nav nav-cta">
              <li class="nav-item">
                <a class="btn btn-outline btn-white rounded-pill" href="contact">
  ...
  <main class="page-main sections-scroll scroll-anim" id="mainpage">
    ...
    <section id="home" class="section hero-item-a ">
      ...
      <div class="section-cover ">
        <!-- <img class="fit opacity-8" src="img/items/portban (2).jpg" alt="person"> -->
        <img class="fit opacity-8" src="img/items/services.jpg" alt="person">
      </div>
          ...
          <div class="row">
            <div class="content-col col-12 col-md-8 text-left">
              ...
              <div class="title-desc">
                <h1 class="display-title hero-title anim-1">Graphic Design</h1>
                <!-- <h4 class="subtitle">Branding, Website</h4> -->
              </div>
    ...
    <section id="products" class="section section-a with-overflow">

        <div class="section-title title-anim sticky-title-off">
          <h2 class="text rellax" data-rellax-speed="5" data-rellax-percentage="0.5" style="transform: translate3d(0px, 802px, 0px);">products</h2>
        </div>
        <!-- Begin of section body -->
        <div class="section-body">
          <!-- content -->
          <div class="section-content container content-width-xxl anim">
  
            <!-- item-list -->
            <div class="part-wrapper">
                <div class="item-list row row-cols-1 row-cols-md-2 row-cols-lg-2 g-5 anim-list">
                    <div class="col">
                    <img src="img/items/graphicdesign02.jpg" alt="person" width="100%">

                    </div>
                    <div class="col">
                       <h1 class="service-heading" >
                       Designing Impactful Visual Experiences

                       </h1>
                        <p class="service-description">
                        Graphic design is a multifaceted field that involves the creation of visual content to communicate messages, ideas, or information effectively. It encompasses a wide range of elements, including typography, imagery, color theory, layout, and composition.
                        </p>
                        <p class="service-subheading">
                          Typography
                        </p>
                        <p class="service-description">
                        Involves the selection and arrangement of fonts to convey written information in a visually appealing and readable manner. This includes choosing appropriate typefaces, font sizes, line spacing, and alignment.
                        </p>
                        <p class="service-subheading">
                        Imagery
                        </p>
                        <p class="service-description">
                        Utilizes photographs, illustrations, icons, and other visual elements to enhance communication and evoke emotions. Graphic designers often manipulate and edit images to fit the overall design aesthetic and convey specific messages.
                        </p>
                        <p class="service-subheading">
                        Color Theory
                        </p>
                        <p class="service-description">
                        Understanding the psychological effects and symbolism of colors is crucial in graphic design. Designers use color palettes strategically to evoke certain moods, emphasize important elements, create visual hierarchy, and establish brand identity.
                        </p>
                      </div>
      ...
      <section id="products" class="section section-a with-overflow">
          ...
          <div class="section-content container content-width-xxl anim">
            ...
            <div class="part-wrapper">
              <div class="item-list row row-cols-1 row-cols-md-2 row-cols-lg-2 g-5 anim-list">
                <div class="col">
                  <!-- card -->
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/portfolioLogo1.jpg" alt="team member">
                      <!-- <video autoplay muted>
                      <source src="img/items/explainer.mp4" type="video/mp4">
                      </video> -->
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
                          <span class="btn btn-solid-a">
                            <span class="icon">
                    ...
                    <div class="item-body item-body-glass rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">Mandowne Apparel</h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">Logo Design</span>
                            </p>
                          </div>
                          <div class="col-auto">
                            <!-- <p class="price">$19</p> -->
                ...
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/BOOKSCOVER.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
                      ...
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            ...
                            <p class="category mb-0">
                              <span class="text-muted-2">Web Design</span>
                            </p>
                          </div>
                          <div class="col-auto">
                            <!-- <p class="price">$19</p> -->
        ...
        <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/illustration1.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
                      ...
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            ...
                            <p class="category mb-0">
                              <span class="text-muted-2">Illustration Design</span>
                            </p>
                          </div>
                          <div class="col-auto">
                            <!-- <p class="price">$19</p> -->
                ...
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/branding.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
                    ...
                    <div class="item-body item-body-glass rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">Ryori</h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">Branding</span>
                            </p>
                          </div>
                          <div class="col-auto">
                            <!-- <p class="price">$19</p> -->
                ...
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/banner.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
                      ...
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            ...
                            <p class="category mb-0">
                              <span class="text-muted-2">Banner Design</span>
                            </p>
                          </div>
                          <div class="col-auto">
                            <!-- <p class="price">$29</p> -->
                ...
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/merch.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
                    ...
                    <div class="item-body item-body-glass rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">Merch </h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">Merch Design</span>
                            </p>
                          </div>
                          <div class="col-auto">
                            <!-- <p class="price">$19</p> -->
                ...
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/poster.jpg" alt="team member">
                    </div>
                    <div class="item-header mask-gradient rounded-md">
                      <div class="row">
                        <div class="col text-start">
                          <!-- <p class="price h4">$29</p> -->
                        </div>
                      </div>
                    </div>
                    <div class="item-body rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">Poster</h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">                            <h4 class="title">Poster Design</h4></span>
                            </p>
                          </div>
                          <div class="col-auto">
                            <span class="btn btn-icon-a">
                              <span class="icon">
                                <i class="ion-md-arrow-forward"></i>
                              </span>
                            </span>
                ...
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/businesscard.jpg" alt="team member">
                    </div>
                    <div class="item-header mask-gradient rounded-md">
                      <div class="row">
                        <div class="col text-start">
                          <!-- <p class="price h4">$799</p> -->
                        </div>
                      </div>
                    </div>
                    <div class="item-body rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">Business Cards</h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">Business Cards Design</span>
                            </p>
                          </div>
                          <div class="col-auto">
                            <span class="btn btn-icon-a">
                ...
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/flyer.jpg" alt="team member">
                    </div>
                    <div class="item-header mask-gradient rounded-md">
                      <div class="row">
                        <div class="col text-start">
                          <!-- <p class="price h4">$59</p> -->
                        </div>
                      </div>
                    </div>
                    <div class="item-body rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">Flyer & Brouchers</h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">Flyer & Brouchers Design</span>
                            </p>
                          </div>
                          <div class="col-auto">
                            <span class="btn btn-icon-a">
                ...
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/logo.jpg" alt="team member">
                    </div>
                    <div class="item-header mask-gradient rounded-md">
                      <div class="row">
                        <div class="col text-start">
    ...
    <section id="contact" class="section section-a section-pt-0">
            ...
            <div class="col-12 col-lg-6 text-left">
              ...
              <div class="title-desc">
                ...
                <div class="d-flex align-items-center  anim-2" data-anim-visible='fade'>
                  <a class="email email-main btn-inline" href="mailto:hello@ourinbox.com" itemprop="email">info@nycreativestudio.com</a>
                ...
                <p class="anim-3" data-anim-visible='fade'>Feel free to ask us any questions related to our activities.
                  We will be happy
                  to answer you.</p>
              </div>
            </div>
