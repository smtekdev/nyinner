  ...
  <main class="page-main sections-scroll scroll-anim" id="mainpage">
    ...
    <section id="home" class="section hero-item-a ">
      ...
      <div class="section-cover ">
        <img class="fit opacity-8" src="img/items/abput.jpg" alt="person">
      </div>
    ...
    <section id="about" class="section section-a ">
      <!-- Begin of section body -->
      <section id="projects" class="section section-a with-overflow active">

        <!-- <div class="section-title title-left text-vert z-top">
          <div class="rellax" data-rellax-speed="6" style="transform: translate3d(0px, -639px, 0px);">
            <h2 class="text text-lg nowrap">Works &amp; Projects</h2>
          </div>
        </div> -->
        <div class="section-body">
          <!-- content -->
          <div class="section-content container content-width anim">
            ...
            <div class="row mb-5">
                <div class="col-12 col-lg-6 text-left">
                    <!-- title and description -->
                    <div class="title-desc">
                        <h2 class="display-3 anim-1 mb-4">Inspiring Digital Evolution.</h2>
                        <p class="anim-2">NY Creative Studio offers comprehensive digital solutions from web development and design to graphic design, social media marketing, search engine optimization, and post-production services.</p>
                        <a class="btn btn-outline btn-white rounded-pill" href="#an_url_here">
                            <span class="text">Contact Us</span>
                        </a>
                    </div>
              </div>
              <div class="col-lg-6 text-right">
                <!-- <a class="btn btn-outline-b btn-white text-spaced text-uppercase" href="#about">
                  <span class="text">Contact</span>
                  
                </a> -->
                <div>
                     <img class="aboutimg" width="130%" style="border-radius: 10px;box-shadow: 5px 5px 8px black;"  src="img/items/about2.jpg" alt="person"/>
                </div>
                
              </div>
            </div>
            <h2 class="display-3 anim-1 mb-4" style="text-align: center; padding-bottom: 100px; margin-top: 100px;" >Our Process</h2>
  
            <!-- item list -->
            <div class="item-list row row-cols-1 row-cols-md-2 g-5">
              <div class="col" style="background: blueviolet;">
                <!-- an item -->
                <a class="item item-feature-c" href="item.html#or_an_url">
                  <div class="item-img anim-hover">
                    <img class="fit" src="img/items/Analyze1.jpg" alt="team member">
                  </div>
                  <div class="icon">
              ...
              <!-- an item -->
              <div class="col" style="background: teal;">
                <!-- an item -->
                <a class="item item-feature-c" href="item.html#or_an_url">
                  <div class="item-img anim-hover">
                    <img class="fit" src="img/items/Design.jpg" alt="team member">
                  </div>
                  <div class="icon">
              ...
              <!-- an item -->
              <div class="col" style="background-color: crimson;margin-top: 0px;">
                <!-- an item -->
                <a class="item item-feature-c" href="item.html#or_an_url">
                  <div class="item-img anim-hover">
                    <img class="fit" src="img/items/Implement.jpg" alt="team member">
                  </div>
                  <div class="icon">
                    <span class="icon-text">03</span>
                  </div>
                  <div class="item-body">
                    <h4>Implement</h4>
                    <span class="btn btn-overline-a">
              ...
              <div class="col" style="background: yellowgreen; margin-top: 0px;">
                <!-- an item -->
                <a class="item item-feature-c" href="item.html#or_an_url">
                  <div class="item-img anim-hover">
                    <img class="fit" src="img/items/Optimize.jpg" alt="team member">
                  </div>
                  <div class="icon">
                    <span class="icon-text">04</span>
                  </div>
                  <div class="item-body">
                    <h4>Optimize.</h4>
                    <span class="btn btn-overline-a">
    ...
    <!-- Begin of about section -->
    <section id="about-image" class="section section-a ">
      <div class="section-cover ">
        <img class="fit opacity-3" src="img/items/why2.jpg" alt="person">
      </div>
        ...
        <div class="section-content container content-width anim">
          <div class="row">
            <div class="col-12 col-lg-12 text-left">
              <!-- title and description -->
              <div class="title-desc">
                <h2 class="display-3 anim-1 mb-4"Style="text-align:center">Why Choose Us</h2>
                <p class="anim-2"Style="text-align:center" >Our New York creative studio is a one-stop destination for all your digital needs. We house a talented team of experts who excel in a variety of areas, including graphic design, web design, web development, post-production, social media management, and SEO. This diversity in skills ensures that you get comprehensive solutions under one roof.</p>
                <!-- <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris aliquet malesuada
                  feugiat.
                  Curabitur fermentum bibendum nulla, non dictum ipsum tincidunt non.</p> -->
              </div>
