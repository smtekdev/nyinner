...
<body id="menu" class="body-page">
 ...
 <!-- <div class="page-loader" id="page-loader">
  ...
  <div class="cover-page">
    <!-- Cover Background -->
    <div class="cover-bg">
      <img class="fit" src="img/bg-default1.jpg" alt="cover">
    </div>
  ...
  <main class="page-main sections-scroll scroll-anim" id="mainpage">
    ...
    <section id="home" class="section hero-a fullscreen-h">
          ...
          <div class="row justify-content-center text-center">
            <div class="content-col col-12 col-md-8 col-lg-8">
              ...
              <div class="title-desc">
                <!-- <h1 data-scroll="" data-scroll-speed="1" class="display-title hero-title anim-1">NY Creative Studio</h1> -->
                <p data-scroll="" data-scroll-speed="3" class="anim-2 hero-desc" style="margin-top: 16%;">Elevate your digital presence with NY Creative Studio, where innovation meets strategy to create impactful online experiences. Our team of experts is dedicated to helping you achieve digital success through cutting-edge solutions tailored to your unique needs.</p>
              </div>
    ...
    <section id="projects" class="section section-a child-sticky fullscreen-h-lg">
      <!-- Begin of section body -->
      <div class="section-body py-5">
        ...
        <div class="section-content content-full px-0 anim scroll-container">

          <!-- Slider main container -->
          <div class="scroll-simple-a ">
            <!-- scroll wrapper -->
            <div class="scroll-wrapper">
              <div class="scroll-slides">
                <!-- Slides -->
                <div class="scroll-slide slide-item-b">
                  <div class="item-wrapper">
                    <div class="item-image rounded-md scale-1">
                      <img src="img/items/img-sample2.jpg" alt="image">
                    </div>
                    <div class="item-content">
                      <h5 class="subtitle speed-1">Projects</h5>
                      <h3 class="title speed-3">Graphic Design</h3>
                      <h4 class="category speed-2">Branding</h4>
                    </div>
                  </div>
                </div>
                <div class="scroll-slide slide-item-b">
                  <div class="item-wrapper">
                    ...
                    <div class="item-content">
                      <h5 class="subtitle speed-1">Projects</h5>
                      <h3 class="title speed-3">Web Design</h3>
                      <h4 class="category speed-2">Website Development</h4>
                    </div>
                  </div>
                </div>
                <div class="scroll-slide slide-item-b">
                  <div class="item-wrapper">
                    ...
                    <div class="item-content">
                      <h5 class="subtitle speed-1">Projects</h5>
                      <h3 class="title speed-3">App Development</h3>
                      <h4 class="category speed-2">Application Development</h4>
                    </div>
                  </div>
                </div>
                <div class="scroll-slide slide-item-b">
                  <div class="item-wrapper">
                    <div class="item-image rounded-md scale-1">
                      <img src="img/items/img-sample1.jpg" alt="image">
                    </div>
                    <div class="item-content">
                      <h5 class="subtitle speed-1">Projects</h5>
                      <h3 class="title speed-3">Animations</h3>
                      <h4 class="category speed-2">3D & 2D Animations</h4>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <section id="team" class="section section-a fullscreen-h-lg">
    ...
    <section id="works" class="section section-a fullscreen-h-lg">
          ...
          <div class="row mb-4">
            <div class="col-12 col-lg-8 text-left">
              ...
              <div class="title-desc" data-anim-visible='fade'>
                ...
                <p class="anim-2">We did so many projects since the beginning of our path. Here are some of the
                  remarkable ones.</p>
              </div>
            </div>
            ...
            <div class="item-list row row-cols-1 row-cols-md-2 g-5 anim-list">
              <div class="col">
                <div class="row row-cols-1 g-5">
                  <div class="col">
                    <!-- card -->
                    <a class="item item-image-b col-12 col-lg-9" href="#" data-anim-visible='fade'>
                      <div class="item-img rounded-md">
                        <img class="fit" src="img/items/img-portrait1.jpg" alt="team member">
                      </div>
                      <div class="item-body">
                        <div class="desc">
                          <h4>Sports Logo Design</h4>
                          <p>Graphic Design</p>
                        </div>
                      </div>
                    </a>
                  ...
                  <div class="col">
                    <!-- card -->
                    <a class="item item-image-b" href="#" data-anim-visible='fade'>
                      <div class="item-img rounded-md">
                        <img class="fit" src="img/items/23.jpg" alt="team member">
                      </div>
                      <div class="item-body">
                        <div class="desc">
                          <h4>App Design</h4>
              ...
              <div class="col">
                <div class="row row-cols-1 g-5">
                  ...
                  <div class="col d-flex justify-content-end">
                    <!-- card -->
                    <a class="item item-image-b col-12 col-lg-9 text-right" href="#" data-anim-visible='fade'>
                      <div class="item-img rounded-md">
    ...
    <section id="subscribe" class="section section-a fullscreen-h-lg">
      <div class="section-title title-anim">
        <div data-anim-visible='zoom-in'>
          ...
          <div class="row justify-content-between">
            <div class="col-12 col-lg-6 text-left">
              ...
              <div class="title-desc pe-lg-5" data-anim-visible='fade'>
                ...
                <p class="anim-2">Don't miss any new opportunity, Hurry up! register now and get early access
    ...
    <section id="reviews" class="section section-a fullscreen-h-lg">
      <div class="section-title title-anim">
        <div data-anim-visible='zoom-in'>
          ...
          <div class="row justify-content-between">
            <div class="col-12 col-lg-6 text-left">
              ...
              <div class="title-desc pe-lg-5" data-anim-visible='fade'>
                ...
                <p class="anim-2">Here are some user feedback about our services and how they help them achieve
                  their goals.</p>
              </div>
