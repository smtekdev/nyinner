  ...
  <main class="page-main sections-scroll scroll-anim" id="mainpage">
    ...
    <section id="home" class="section hero-item-a ">
      ...
      <div class="section-cover ">
        ...
        <img class="fit opacity-8" src="img/items/postproduction.jpg" alt="person">
      </div>
          ...
          <div class="row">
            <div class="content-col col-12 col-md-8 text-left">
              ...
              <div class="title-desc">
                <h1 class="display-title hero-title anim-1">Post Production</h1>
          ...
          <div class="section-content container content-width-xxl anim">
            ...
            <div class="part-wrapper">
                <div class="item-list row row-cols-1 row-cols-md-2 row-cols-lg-2 g-5 anim-list">
                    <div class="col">
                    <img src="img/items/postproductionv.jpg" alt="person" width="100%">

                    </div>
                    <div class="col">
                       <h1 class="service-heading" >
                       Enhancing Content Professionally

                       </h1>
                        <p class="service-description">
                        Post-production refers to the phase of filmmaking, photography, or audio production that occurs after the initial recording or shooting is complete. It encompasses a variety of tasks aimed at refining and enhancing the raw material to create a polished and professional final product. 
                        </p>
                        <p class="service-subheading">
                        Editing
                        </p>
                        <p class="service-description">
                        Editing is one of the primary tasks in post-production, involving the selection, arrangement, and manipulation of footage or audio clips to create a coherent and compelling narrative. Editors use specialized software such as Adobe Premiere Pro, Final Cut Pro, or Avid Media Composer to trim footage, add transitions, and create seamless sequences that effectively convey the intended message or story.
                        </p>
                        <p class="service-subheading">
                        Visual Effects (VFX)
                        </p>
                        <p class="service-description">
                        Visual effects are computer-generated or enhanced elements added to a video or film to create illusions or enhance realism. VFX artists use software such as Autodesk Maya, Adobe After Effects, or Nuke to create and composite visual effects such as CGI animations, green screen compositing, motion tracking, and particle simulations that add depth and visual interest to the final product.
                        </p>
