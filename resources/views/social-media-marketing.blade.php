  ...
  <main class="page-main sections-scroll scroll-anim" id="mainpage">
    ...
    <section id="home" class="section hero-item-a ">
      ...
      <div class="section-cover ">
        ...
        <img class="fit opacity-8" src="img/items/smm.jpg" alt="person">
      </div>
          ...
          <div class="row">
            <div class="content-col col-12 col-md-8 text-left">
              ...
              <div class="title-desc">
                <h1 class="display-title hero-title anim-1">Social Media Marketing </h1>
          ...
          <div class="section-content container content-width-xxl anim">
            ...
            <div class="part-wrapper">
                <div class="item-list row row-cols-1 row-cols-md-2 row-cols-lg-2 g-5 anim-list">
                    <div class="col">
                    <img src="img/items/smm1.jpg" alt="person" width="100%">
                    ...
                    <div class="col">
                       ...
                       Engaging Audiences, Building Brands
                        ...
                        Social media marketing is a form of digital marketing that utilizes social media platforms to promote products, services, or brands and engage with target audiences. It involves creating and sharing content on social media networks such as Facebook, Instagram, Twitter, LinkedIn, and YouTube to attract attention, generate leads, and drive website traffic. 
                        </p>
                        <p class="service-subheading">
                         Audience Research and Targeting
                        </p>
                        <p class="service-description">
                        Social media marketers conduct research to understand their target audience's demographics, interests, and behaviors. They use this information to create targeted social media campaigns that resonate with their audience and drive engagement and conversions.
                        ...
                        <p class="service-description">
                        Social media platforms offer advertising options that allow marketers to reach specific audiences with targeted ads. Social media marketers create and manage ad campaigns, set budgets and targeting criteria, and monitor performance metrics to optimize ad performance and ROI.
                        </p>
