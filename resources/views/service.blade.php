...
<body id="menu" class="body-page">
  ...
  <main class="page-main sections-scroll scroll-anim" id="mainpage">
          ...
          <div class="row">
            <div class="content-col col-12 col-md-8 text-left">
              ...
              <div class="title-desc">
                <h1 class="display-title hero-title anim-1">Our Services</h1>
    ...
    <section id="products" class="section section-a with-overflow">
          ...
          <div class="section-content container content-width-xxl anim">
            ...
            <div class="part-wrapper">
              <div class="item-list row row-cols-1 row-cols-md-2 row-cols-lg-2 g-5 anim-list">
                <div class="col">
                  <!-- card -->
                  <a href="graphic-design" class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/service1.jpg" alt="team member">
                ...
                <div class="col">
                  <!-- card -->
                  <a href="web-designing" class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/services2.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
        ...
        <div class="col">
                  <!-- card -->
                  <a href="3d-art" class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/3dart.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
                ...
                <div class="col">
                  <!-- card -->
                  <a href="social-media-marketing" class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/services4.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
                ...
                <div class="col">
                  <!-- card -->
                  <a href="search-engine-optimization" class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/service5.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
                ...
                <div class="col">
                  <!-- card -->
                  <a href="post-production" class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/service6.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
