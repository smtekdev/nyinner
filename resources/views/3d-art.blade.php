  ...
  <main class="page-main sections-scroll scroll-anim" id="mainpage">
    ...
    <section id="home" class="section hero-item-a ">
      ...
      <div class="section-cover ">
        ...
        <img class="fit opacity-8" src="img/items/3d.jpg" alt="person">
      </div>
          ...
          <div class="row">
            <div class="content-col col-12 col-md-8 text-left">
              ...
              <div class="title-desc">
                <h1 class="display-title hero-title anim-1">3D Art </h1>
          ...
          <div class="section-content container content-width-xxl anim">
            ...
            <div class="part-wrapper">
                <div class="item-list row row-cols-1 row-cols-md-2 row-cols-lg-2 g-5 anim-list">
                    <div class="col">
                    <img src="img/items/3dv.jpg" alt="person" width="100%">

                    </div>
                    <div class="col">
                       <h1 class="service-heading" >
                       Sculpting Digital Dimensions Creatively

                       </h1>
                        <p class="service-description">
                        3D art, also known as three-dimensional art, refers to the creation of visual works that have depth, volume, and spatial qualities. It encompasses a wide range of techniques and mediums, including digital modeling, sculpting, rendering, and animation.
                        </p>
                        <p class="service-subheading">
                          Digital Modeling
                        </p>
                        <p class="service-description">
                        Digital modeling involves creating three-dimensional objects using specialized software such as Blender, Maya, 3ds Max, or ZBrush. Artists use a variety of tools and techniques to shape and manipulate virtual objects, including polygonal modeling, sculpting, and parametric modeling.
                        </p>
                        <p class="service-subheading">
                        Sculpting
                        </p>
                        <p class="service-description">
                        3D sculpting is similar to traditional sculpting but takes place in a digital environment. Artists use digital sculpting software like ZBrush or Mudbox to sculpt detailed and organic forms, adding and subtracting digital clay to create intricate textures, shapes, and surface details
                        </p>
                        <p class="service-subheading">
                        Texturing
                        </p>
                        <p class="service-description">
                        Texturing involves adding surface detail and texture to 3D models to make them appear more realistic or stylized. Artists use texture painting software like Substance Painter or Mari to create and apply textures such as color maps, bump maps, specular maps, and displacement maps to their models.
...
<!-- 
            ...
            <div class="part-wrapper">
              <div class="item-list row row-cols-1 row-cols-md-2 row-cols-lg-2 g-5 anim-list">
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/AIRCRAFT.jpg" alt="team member">
                    ...
                    <div class="item-body item-body-glass rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">AirCraft</h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">3D Art</span>
                            </p>
                          </div>
                          <div class="col-auto">
                            <!-- <p class="price">$19</p> -->
                ...
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/FIRSTRENDER.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
        ...
        <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/3DCharacter.png" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
                    ...
                    <div class="item-body item-body-glass rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">3D Character </h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">3D Art</span>
                            </p>
                          </div>
