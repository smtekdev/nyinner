  ...
  <main class="page-main sections-scroll scroll-anim" id="mainpage">
    ...
    <section id="home" class="section hero-item-a ">
      ...
      <div class="section-cover ">
        ...
        <img class="fit opacity-8" src="img/items/webdesignhorizontal.jpg" alt="person">
      </div>
          ...
          <div class="row">
            <div class="content-col col-12 col-md-8 text-left">
              ...
              <div class="title-desc">
                <h1 class="display-title hero-title anim-1">Web Design & Development</h1>
    ...
    <section id="products" class="section section-a with-overflow">
          ...
          <div class="section-content container content-width-xxl anim">
            ...
            <div class="part-wrapper">
                <div class="item-list row row-cols-1 row-cols-md-2 row-cols-lg-2 g-5 anim-list">
                    <div class="col">
                    <img src="img/items/webdh.jpg" alt="person" width="100%">

                    </div>
                    <div class="col">
                       <h1 class="service-heading" >
                       Crafting Interactive Digital Landscapes

                       </h1>
                        <p class="service-description">
                        Web design is a specialized field within graphic design that focuses on the planning, creation, and maintenance of websites. It involves a combination of creative and technical skills to produce visually appealing, functional, and user-friendly websites.
                        </p>
                        <p class="service-subheading">
                        (UI) Design
                        </p>
                        <p class="service-description">
                        UI design is concerned with the visual layout and presentation of elements on a website. This includes designing navigation menus, buttons, forms, and other interactive components to ensure intuitive and efficient user interaction.
                        </p>
                        <p class="service-subheading">
                        (UX) Design
                        </p>
                        <p class="service-description">
                        UX design focuses on understanding the needs and behaviors of website users and creating designs that provide a positive and meaningful experience. This involves conducting user research, creating personas, and designing user flows to optimize usability and satisfaction.
                        </p>
                        <p class="service-subheading">
                        Responsive Design
                        </p>
                        <p class="service-description">
                        With the increasing use of mobile devices, responsive design has become essential. Web designers must create websites that adapt and respond seamlessly to different screen sizes and devices, ensuring a consistent and optimal experience for users across desktops, tablets, and smartphones.
                        </p>
                      </div>
      ...
      <section id="products" class="section section-a with-overflow">
            ...
            <div class="part-wrapper">
              <div class="item-list row row-cols-1 row-cols-md-2 row-cols-lg-2 g-5 anim-list">
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/web1.jpg" alt="team member">
                    ...
                    <div class="item-body item-body-glass rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">Beauty Salon</h4>
                ...
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/web2.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
                    ...
                    <div class="item-body item-body-glass rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">Digital Agency</h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">Web Design</span>
                            </p>
                          </div>
        ...
        <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/web3.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
                    ...
                    <div class="item-body item-body-glass rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">Piano Classes </h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">Web Design</span>
                            </p>
                          </div>
                ...
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/web4.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
                ...
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/web5.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
                ...
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/web6.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
